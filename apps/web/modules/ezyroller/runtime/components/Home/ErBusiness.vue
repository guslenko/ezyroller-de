<template>
  <section class="w-full py-4 px-4">
    <div class="max-w-6xl mx-auto items-center">
      ...
      <div class="max-w-screen-2xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-0 md:gap-6 sm:gap-8 px-4 pb-4">
        <!-- BLOCK 1 -->
        <div class="flex items-center gap-3 py-4 border-y md:border-none border-zinc-300">
          <img
            src="https://cdn02.plentymarkets.com/4in9ikd3ipve/frontend/www-ezyroller-de/icon1.webp"
            alt=""
        ...
        <div class="flex items-center gap-3 py-4 border-b md:border-none border-zinc-300">
          <img
            src="https://cdn02.plentymarkets.com/4in9ikd3ipve/frontend/www-ezyroller-de/icon2.webp"
            alt=""
            class="h-14 w-14 mr-4"
          />
          <div class="flex flex-col leading-tight text-left font-normal text-xl">
        ...
        <div class="flex items-center gap-3 py-4 border-b md:border-none border-zinc-300">
          <img
            src="https://cdn02.plentymarkets.com/4in9ikd3ipve/frontend/www-ezyroller-de/icon3.webp"
            alt=""
            class="h-14 w-14 mr-4"
          />
          <div class="flex flex-col leading-tight text-left font-normal text-xl">
  ...
  <section class="w-full py-4 px-4">
    <div class="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
      ...
      <div class="order-2 md:order-1 text-gray-800">
        <span class="text-base text-gray-700 uppercase font-normal tracking-[0.5em] block">EzyRoller</span>
        <h3 class="text-3xl uppercase font-bold mb-4 p-0">{{ $t('biz8') }}</h3>

        <ul class="list-disc pl-5">
          <li class="text-base font-medium leading-relaxed pt-1">
            {{ $t('biz9') }}
          </li>
          <li class="text-base font-medium leading-relaxed pt-1">
            {{ $t('biz10') }}
  ...
  <section class="w-full py-4 px-4">
    <div class="max-w-6xl mx-auto items-center">
      <h3 class="text-3xl uppercase font-bold mb-0 px-0 py-2 text-center">{{ $t('biz18') }}</h3>
    </div>
  </section>
      ...
      <div class="order-2 md:order-1 text-gray-800">
        <div class="flex items-center gap-4">
          ...
          <div class="flex flex-col">
            ...
            <h3 class="text-3xl uppercase font-bold mb-0 p-0">
              {{ $t('biz19') }}
            </h3>
          </div>
        </div>
