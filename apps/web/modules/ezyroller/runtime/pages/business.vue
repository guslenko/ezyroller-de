<template>
  ...
  <NuxtLayout name="page">
    <div class="max-w-[700px] mx-auto p-6" id="business">
      ...
      <!-- SUCCESS -->
      <div v-if="success" class="p-6 bg-green-50 border border-green-200 rounded-md text-center">
      ...
      <form v-else class="flex flex-col gap-6" @submit.prevent="submitForm">
        <!-- FIRMA -->
        <div>
          <label class="block mb-1 font-medium"> {{ $t('business1') }} <span class="text-red-600">*</span> </label>
        ...
        <div class="grid grid-cols-2 gap-4">
          <div>
            <label class="block mb-1 font-medium"> {{ $t('business2') }} <span class="text-red-600">*</span> </label>
          ...
          <div>
            <label class="block mb-1 font-medium"> {{ $t('business3') }} <span class="text-red-600">*</span> </label>
        ...
        <div class="grid grid-cols-2 gap-4">
          <div>
            <label class="block mb-1 font-medium"> {{ $t('business4') }} <span class="text-red-600">*</span> </label>
          ...
          <div>
            <label class="block mb-1 font-medium"> {{ $t('business5') }} <span class="text-red-600">*</span> </label>
        ...
        <div class="grid grid-cols-3 gap-4">
          <div class="col-span-1">
            <label class="block mb-1 font-medium"> {{ $t('business6') }} <span class="text-red-600">*</span> </label>
          ...
          <div class="col-span-2">
            <label class="block mb-1 font-medium"> {{ $t('business7') }} <span class="text-red-600">*</span> </label>
        ...
        <!-- MESSAGE -->
        <div>
          <label class="block mb-1 font-medium"> {{ $t('business8') }} <span class="text-red-600">*</span> </label>
          <SfTextarea v-model="message" class="w-full" :invalid="submitted && messageError" />
        ...
        <div>
          <label class="flex items-start gap-3 text-sm text-neutral-700 cursor-pointer">
            <input type="checkbox" v-model="consent" class="mt-1 h-4 w-4 border-neutral-400 rounded" />
            <span>
              {{ $t('business9') }}
...
import ErBusiness from '#ezyroller/components/Home/ErBusiness.vue';
import ErBVideo from '#ezyroller/components/Home/ErBVideo.vue';
