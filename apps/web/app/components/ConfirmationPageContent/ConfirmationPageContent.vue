  ...
  <div class="px-4 md:px-0 flex items-center flex-col" data-testid="order-success-page">
    ...
    <div class="flex flex-col md:flex-row w-full md:w-auto lg:w-3/4 flex-wrap gap-x-6">
      <div class="flex-1">
        ...
        <div>
          <a :tag="NuxtLink" :href="localePath('/widerrufsformular')" class="inline-flex items-center justify-center font-medium text-base focus-visible:outline focus-visible:outline-offset rounded-md disabled:text-disabled-500 disabled:bg-disabled-300 disabled:shadow-none disabled:ring-0 disabled:cursor-not-allowed py-2 leading-6 px-4 gap-2 text-white shadow hover:shadow-md active:shadow bg-primary-500 hover:bg-primary-600 active:bg-primary-700 disabled:bg-disabled-300 mt-2">
                {{ $t("textWidgetL0") }}
          </a>
        </div>
      </div>
