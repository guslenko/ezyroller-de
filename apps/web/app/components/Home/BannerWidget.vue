<template>
  <section class="w-full px-2 py-4">
    <div class="w-full mx-auto grid gap-4 px-0 md:px-2">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        >
          <div
            class="w-full h-[290px] md:h-[380px] lg:h-[480px]
          ...
          <div class="absolute bottom-10 left-1/2 -translate-x-1/2 text-center space-y-1 z-20">
            <div class="-rotate-3 text-white text-base md:text-lg uppercase font-medium drop-shadow-md">AWARD WINNING</div>
            <div class="-rotate-3 text-white text-2xl md:text-3xl uppercase font-bold drop-shadow-md pb-4">Pro moves. Pro attitude.</div>
            <div
              class="inline-block mt-2 px-6 py-2 border border-white text-white font-bold rounded-md
                     shadow-md -rotate-3 group-hover:scale-125 mt-2 transition-all duration-300
        ...
        >
          ...
          <div class="absolute bottom-10 left-1/2 -translate-x-1/2 text-center space-y-1 z-20">
            <div class="-rotate-3 text-white text-base md:text-lg uppercase font-medium drop-shadow-md">AWARD WINNING</div>
            <div class="-rotate-3 text-white text-2xl md:text-3xl uppercase font-bold drop-shadow-md pb-4">Drift harder. Ride smoother.</div>
            <div
              class="inline-block mt-2 px-6 py-2 border border-white text-white font-bold rounded-md
                     shadow-md -rotate-3 group-hover:scale-125 mt-2 transition-all duration-300
                     bg-white/10 group-hover:bg-white group-hover:text-black backdrop-blur-md"
      ...
      >
        ...
        <div class="absolute bottom-10 left-1/2 -translate-x-1/2 text-center space-y-1 z-20">
          <div class="-rotate-3 text-white text-base md:text-lg uppercase font-medium drop-shadow-md">Ride and shoot!</div>
          <div class="-rotate-3 text-white text-2xl md:text-3xl uppercase font-bold drop-shadow-md pb-4">Rolling and scoring - the ultimate combo.</div>
          <div
            class="inline-block mt-2 px-6 py-2 border border-white text-white font-bold rounded-md
                   shadow-md -rotate-3 group-hover:scale-125 mt-2 transition-all duration-300
                   bg-white/10 group-hover:bg-white group-hover:text-black backdrop-blur-md"
  ...
  >
    ...
    <!-- TEXT BLOCK -->
    <div class="absolute bottom-10 left-1/2 -translate-x-1/2 text-center space-y-1 z-30">
      <div class="-rotate-3 text-white text-base md:text-lg uppercase font-medium drop-shadow-md">
        Award Winning aCCESsORies
      </div>
      <div class="-rotate-3 text-white text-2xl md:text-3xl uppercase font-bold drop-shadow-md pb-4">
      ...
      <div
        class="inline-block mt-2 px-6 py-2 border border-white text-white font-bold rounded-md
               shadow-md -rotate-3 group-hover:scale-125 transition-all duration-300
               bg-white/10 group-hover:bg-white group-hover:text-black backdrop-blur-md"
      >
        HOCKEY SET
      </div>
