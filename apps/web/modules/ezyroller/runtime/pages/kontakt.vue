    ...
    <div class="max-w-[600px] mx-auto p-6">
      ...
      <form v-else class="flex flex-col gap-4" @submit.prevent="submitForm">
        ...
        <div>
          ...
          <p v-if="submitted && nameError" class="text-red-600 text-sm mt-1">Bitte geben Sie Ihren Namen ein.</p>
        </div>
        ...
        <div>
          ...
          <p v-if="submitted && messageError" class="text-red-600 text-sm mt-1">Bitte geben Sie eine Nachricht ein.</p>
        </div>
        ...
        <div>
          ...
          <p v-if="submitted && consentError" class="text-red-600 text-sm mt-1">Bitte Zustimmung erteilen.</p>
        </div>
...
const formValid = computed(() => !nameError.value && !emailError.value && !messageError.value && !consentError.value);
