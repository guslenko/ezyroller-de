  ...
  <section class="w-full py-4 px-4">
    <div class="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
      ...
      <div class="order-2 md:order-1 text-gray-800">
        <h1 class="text-base text-gray-700 uppercase font-normal tracking-[0.5em] block">EzyRoller</h1>
        <h3 class="text-3xl uppercase font-bold mb-4 p-0">{{ $t('textWidgetTitle') }}</h3>
      ...
      <div class="max-w-3xl mx-auto relative">
        ...
        >
          ...
          <NuxtLink
            ...
            class="inline-block whitespace-nowrap text-center px-8 py-3 border border-black text-white text-lg font-semibold transition-all duration-300 hover:bg-black hover:text-white hover:shadow-xl bg-black backdrop-blur-md rounded-md"
