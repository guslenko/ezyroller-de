<template>
  <div class="text-sm py-1">
    <span
      class="mr-2 text-black font-medium"
    ...
    <span
      v-if="props.crossedPrice && differentPrices"
      class="text-base font-normal bg-amber-300 px-2 py-0 rounded-md text-neutral-500 line-through"
    >
