  ...
  <NuxtLayout name="page">
    <div class="max-w-[700px] mx-auto p-6" id="widerruf">
      ...
      <form v-else class="flex flex-col gap-6" @submit.prevent="submitForm">
        <!-- ORDER NUMBER -->
        <div>
          <label class="block mb-1 font-medium"> {{ $t('textWidgetL01') }} <span class="text-red-600">*</span> </label>
        ...
        <!-- FULL NAME -->
        <div>
          <label class="block mb-1 font-medium"> {{ $t('textWidgetL02') }} <span class="text-red-600">*</span> </label>
        ...
        <!-- EMAIL -->
        <div>
          <label class="block mb-1 font-medium"> {{ $t('textWidgetL03') }} <span class="text-red-600">*</span> </label>
        ...
        <div>
          ...
          <SfTextarea v-model="reason" class="w-full" />
        </div>
...
const formValid = computed(() => !orderIdError.value && !fullnameError.value && !emailError.value);
